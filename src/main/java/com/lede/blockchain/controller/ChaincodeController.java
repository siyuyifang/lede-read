...
import com.lede.blockchain.dto.ChaincodeNameDto;
import com.lede.blockchain.dto.FunctionAndArgsDto;
import com.lede.blockchain.dto.UserDto;
...
public class ChaincodeController {
     ...
     *
     * @param user of the user registered and enrolled in com.lede.blockchain.
    ...
    public ResponseEntity<String> enroll(@RequestBody UserDto user) {
        ...
        String result = chaincodeService.enrollAndRegister(user.getCellphone());
